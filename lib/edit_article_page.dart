...
class _EditArticlePageState extends State<EditArticlePage> {
  ...
  static const bannedWords = [
    ...
    'douche', 'douchebag', 'wtf','omg', 'lmao', 'rofl', 'nigga', 'brb', 'btw', 'fml',
    'idk', "ain't", 'gonna', 'wanna', "y'all",'nah', 'uh-huh',
    ...
    'insane', 'bonkers', 'fatass','savage','dope',
    'no cap', 'salty', 'thirsty', 'lowkey', 'highkey', 'flex', 'clout',
    'tool', 'boomer', 'fugly', 'buttface', 'nasty', 'gross','eww', 'effed up',
